...
.product .product-sidebar button.buy {
  background: transparent url("https://i.postimg.cc/m2R4Kw3c/icons8-add-to-cart-64.png") no-repeat 15px;
  
}
.product .product-sidebar button.info {
  background: transparent url("https://i.postimg.cc/7YbGJwcM/deletei.png") no-repeat 15px;
}
.product .product-sidebar button.size {
  background: transparent url("https://i.postimg.cc/WzN9whr4/icons8-update-64.png") no-repeat 15px;
  width: 20px;
}
